...
/**
 * A MalformedLineError is thrown in case of detecting a malformed line in files
 * from the {@linkplain Database}.
 *
 * @author dinomario10
 */
public class MalformedLineError extends Error {
	private static final long serialVersionUID = 948412883808532830L;
